...
<head>
    ...
    <style>
        body {
            ...
            font-size: 13px;
            /* Tamaño de fuente óptimo para PDFs */
            color: #333333;
            margin: 0 auto;
            max-width: 750px;
            /* Un poco más de ancho para contenido */
        ...
        .container {
            ...
            /* Comentado por posible inconsistencia */
            overflow: hidden;
        ...
        .client-info-table {
            ...
            border: 1px solid #e0e0e0;
            /* Borde para la tabla de cliente */
            border-radius: 6px;
            overflow: hidden;
            /* Intento para que border-radius funcione en tablas */
        }
        ...
        .details-table .price-row td {
            font-size: 15px;
            /* Precio más grande en la tabla */
            font-weight: bold;
            color: #002F5F;
            background-color: #e6f7ff;
            /* Fondo para la fila de precio */
        }
        ...
        .comments-section strong {
            color: #a07d00;
            /* Color más oscuro para el título de comentarios */
        }
        ...
        .whatsapp-button {
            ...
            line-height: 1;
            /* Asegura que el texto y la imagen se alineen */
            vertical-align: middle;
            /* Para alinear el texto con el icono si se agrega */
        }
        ...
        .footer .social-links a {
            color: #002F5F;
            /* Color corporativo para enlaces */
            text-decoration: none;
            margin: 0 10px;
            display: inline-block;
            vertical-align: middle;
...
<body>
    ...
    <div class="container">
        ...
        <div class="header">
            <img class="logo" src="https://i.imgur.com/your-visualled-logo.png" alt="Logo VISUALLED" />
            <h1>Solicitud de Presupuesto</h1>
            <div class="badge">NUEVO PEDIDO</div>
            <p>
                <span class="request-id">ID: {{ $idPedido ?? 'No Asignado' }}</span> | Generado:
                {{ date('d/m/Y \a \l\a\s H:i', strtotime($fechaGeneracion ?? 'now')) }}
            </p>
        </div>
        ...
        <div class="whatsapp-button-container">
            <a href="https://wa.me/{{ $telefono ?? '' }}?text=Hola%20{{ urlencode(explode(' ', $nombre)[0] ?? 'cliente') }},%20soy%20del%20equipo%20VISUALLED,%20estamos%20revisando%20tu%20solicitud%20de%20presupuesto."
                ...
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/6b/WhatsApp.svg/100px-WhatsApp.svg.png"
                    alt="WhatsApp Icon" /> Contactar por WhatsApp
            </a>
        </div>
