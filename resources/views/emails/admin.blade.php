...
<head>
    ...
    <style type="text/css">
        ...
        body { font-family: 'Poppins', Arial, sans-serif; background-color: #f5f7fa; margin: 0; padding: 0; color: #333; }
        ...
        .header { background: linear-gradient(135deg, #6e8efb, #a777e3); padding: 30px 20px; color: white; text-align: center; }
        ...
        .detail-label { font-weight: 600; color: #6e8efb; min-width: 150px; }
        .footer { text-align: center; padding: 20px; background: #f5f7fa; color: #7f8c8d; font-size: 12px; }
        .social-links { margin: 15px 0; }
        .social-links a { margin: 0 10px; text-decoration: none; }
        .priority { background: #fff8e1; padding: 10px 15px; border-left: 4px solid #ffc107; margin: 20px 0; }
        .btn { display: inline-block; background: #6e8efb; color: white; padding: 12px 25px; text-decoration: none; border-radius: 30px; font-weight: 500; margin-top: 15px; }
    </style>
</head>
<body>
    <div class="container">
        <div class="header">
            <img src="https://previews.123rf.com/images/lumut/lumut1809/lumut180900116/107803129-tv-lcd-led-monitor-icon-vector-illustration-design-logo.jpg" alt="Logo Empresa" class="logo">
        ...
        <div class="content">
            ...
            <div class="details">
                ...
                <div class="detail-item">
                    ...
                    <span>{{ $datos['empresa'] ?? 'No especificada' }}</span>
                </div>
                <div class="detail-item">
