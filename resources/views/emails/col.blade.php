...
<head>
    ...
    <style>
        ...
        .email-container {
            ...
            /* Sombra más pronunciada pero elegante */
            overflow: hidden;
        ...
        .header {
            ...
            /* Verde vibrante para el éxito/nuevo pedido */
            color: #ffffff;
            padding: 30px 25px;
            text-align: center;
        ...
        .order-summary {
            ...
            /* Fondo claro para los detalles */
            border-left: 6px solid #4CAF50;
            /* Barra lateral del color primario */
            padding: 20px 25px;
            margin: 25px 0;
            border-radius: 8px;
            box-shadow: 0 2px 8px rgba(0, 0, 0, 0.05);
            /* Sombra suave para el bloque de detalles */
        }
        ...
        .action-button {
            ...
            /* Amarillo para el botón de acción, llama la atención */
            color: #333333;
            /* Texto oscuro para el botón amarillo */
            padding: 15px 30px;
            border-radius: 8px;
        ...
        .action-button:hover {
            ...
            /* Amarillo más oscuro al pasar el mouse */
...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p style="font-size: 17px; margin-bottom: 25px;">Hola Jhony Lezama, tienes un nuevo pedido listo para ser
                revisado y gestionado. ¡Manos a la obra!</p>
            ...
            <div class="order-summary">
                ...
                <ul>
                    <li>
                        ...
                        @if (isset($tipo_documento) && $tipo_documento === 'RUC')
                            {{ $datos['empresa'] ?? 'N/A' }}
                        @else
                            {{ $datos['nombre'] ?? 'N/A' }}
                        @endif
            ...
            <p style="font-size: 16px;">Por favor, revisa esta información con prontitud para asegurar un excelente
                servicio al cliente.</p>
        </div>
        <div class="action-button-container">
            <a href="TU_ENLACE_A_LA_PLATAFORMA_DE_PEDIDOS" class="action-button" target="_blank">Revisar Pedido
                Completo</a>
        </div>
        <div class="footer">
            <p>Este es un mensaje generado automáticamente. Por favor, no respondas a este correo.</p>
            <p>&copy; 2025 Tu Empresa. Todos los derechos reservados.</p>
            <p><a href="URL_DE_POLITICA_DE_PRIVACIDAD" target="_blank">Política de Privacidad</a> | <a
                    href="URL_DE_TERMINOS_Y_CONDICIONES" target="_blank">Términos y Condiciones</a></p>
        </div>
    </div>
