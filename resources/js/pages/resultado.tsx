        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-gray-100 p-4">
          <div className="bg-white shadow-xl rounded-lg p-8 max-w-md w-full text-center transform transition-all hover:shadow-2xl">
            ...
            <div className="flex justify-center gap-4 mt-6">
              <button
                className="bg-blue-600 hover:bg-blue-700 cursor-pointer text-white px-6 py-2 rounded-full flex items-center gap-2 transition"
                onClick={() => setShowModal(true)}
              >
                <FontAwesomeIcon icon={faPaperPlane} /> Solicitar presupuesto
              </button>
              <button
                className="bg-gray-200 hover:bg-gray-300 cursor-pointer text-gray-800 px-6 py-2 rounded-full transition"
                onClick={() => navigate('/')}
              >
                Calcular otro
              </button>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="flex justify-end gap-3 mt-6">
                    <button
                      type="button"
                      onClick={() => setShowModal(false)}
                      className="px-4 py-2 text-gray-700 border cursor-pointer border-gray-300 rounded-lg hover:bg-gray-100 transition"
                      disabled={loading}
                    >
                      Cancelar
                    </button>
                    <button
                      type="submit"
                      disabled={loading}
                      className={`px-4 py-2 rounded-lg transition text-white flex items-center justify-center gap-2 ${
                        loading
